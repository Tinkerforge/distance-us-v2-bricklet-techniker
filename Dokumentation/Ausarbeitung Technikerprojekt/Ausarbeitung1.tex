...
\chapter{Einleitung}
\input{15_Zusammenfassung}
\input{2_Lasten_und_Pflichtenheft}
\newpage
\section{Management des Projektes}
\input{3_Management_des_Projektes}
\section{Richtlinien zu Erstellung von Schaltplänen und Platinenlayout anhand von einem ECAD-Programmpaket}
\input{6_Open_Source_CAD-Programm}
...
%\bibliography{bibliothek}%Nutzung einer externen Bibliothek für Literatur
