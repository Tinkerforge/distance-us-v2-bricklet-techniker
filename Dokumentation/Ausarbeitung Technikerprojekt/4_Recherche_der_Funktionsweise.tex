...
\end{lstlisting}
\captionof{figure}{Ohne API für ein Programmbeispiel anhand einer PULL-UP Initialisierung}
\label{fig:oAPI}
\end{minipage}

Eine besonderheit 
Um die die Lesbarkeit des Programms zu fördern wurden APIs (Application Programming Interface) verwendet anstatt jedes Register einzeln anzusprechen.Das erlaubt Programme leichter zuwarten.
Siehe\ref{API} : Die API für ein Programmbeispiel anhand einer PULL-UP Initialisierung. 
