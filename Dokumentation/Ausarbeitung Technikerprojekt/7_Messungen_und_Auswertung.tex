...
\begin{figure}[H]
\includegraphics[width=0.6\textwidth, draft]{Abbildungen/PWM-Nach der Halbbrücke.png}\caption{PWM Ausgabe über eine Halbbrucke}\label{fig:Halfbridge}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\textwidth, draft]{Abbildungen/PWM-Nach der Halbbrücke mit LS.png}\caption{PWM Ausgabe am Sender}\label{fig:Sender}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\textwidth]{Abbildungen/Signal am Empfänger.png}\caption{Signal Empfang}\label{fig:Empfang am LS}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\textwidth, draft]{Abbildungen/Signal nach Verstärkung.png}\caption{Signal nach Verstärkung}\label{fig:Verstaerkung}
\end{figure}
...
\begin{figure}[H]
\includegraphics[width=0.6\textwidth, draft]{Abbildungen/Signal nach Verstärkung2.png}\caption{Signal nach Verstärkung2}\label{fig:Verstaerkung2}
\end{figure}
\begin{figure}[H]
